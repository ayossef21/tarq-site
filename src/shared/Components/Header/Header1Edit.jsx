...
import NavEdit from '@/shared/Components/Header/NavEdit';
import Link from 'next/link';
import Image from 'next/image';

export default function Header1Edit({ variant }) {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (currentScrollPos > prevScrollPos) {
                ...
                setIsSticky(''); // Set empty string instead of undefined
            }
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="pera">
                                    <p>
                                        <Image src="/assets/images/logo/logo-tarq-w.png" alt="img" width={25} height={25} />
                                        Innovate, Learn, and Lead With Cutting-Edge IT Solutions & Training
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="cs_main_header_in">
                            ...
                            <div className="cs_main_header_left">
                                <Link className="cs_site_branding" href="/">
                                    ...
                                    <Image src="/assets/images/logo/header/header-logo1.png" alt="img" width={190} height={28} />
                                </Link>
                            </div>
                            ...
                            <div className="cs_main_header_center1">
                                <div className="cs_nav cs_primary_font fw-medium">
                                    ...
                                    <NavEdit setMobileToggle={setMobileToggle} />
                                </div>
                            </div>
                            <div className="cs_main_header_right header_right_one">
                                ...
                                <div className="header1-buttons">
                                    ...
                                    <div className="button">
                                        <Link href="#" className="theme-btn1" >Sign in<span><i className="bi bi-arrow-right"></i>
                                        </span></Link>
                                    </div>
                                </div>
